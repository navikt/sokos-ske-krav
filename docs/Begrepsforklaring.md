...
### Knyttet til Krav
| Begrep                   | Betyr i Nav                                             | Betyr i Skatt                   | kKommentar                                                                                                                                                                                                   |
|:-------------------------|:--------------------------------------------------------|:--------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| Vedtaksdato              | Vedtaksdato                                             | FastsettelsesDato               | Datoen da tilbakrevingsvedtaket ble opprettet                                                                                                                                                                |
| UtbetalDato              | Utbetalingsdato                                         | ForeldelsesFristensUtgangspunkt | Datoen da feilutbetalingen ble utbetalt                                                                                                                                                                      |
| FremtidigYtelse          | ???                                                     | YtelseForAvregningBeloep        | Total ytelse tilgjengelig for avregning, om noe. Benyttes av innkrevingsmyndigheten ved "avregning" som innkrevingstiltak.                                                                                   |
