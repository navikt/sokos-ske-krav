ALTER TABLE krav
    ...
    ALTER COLUMN tidspunkt_sendt TYPE TIMESTAMPTZ USING tidspunkt_sendt AT TIME ZONE 'Europe/Oslo',
    ALTER COLUMN tidspunkt_siste_status TYPE TIMESTAMPTZ USING tidspunkt_siste_status AT TIME ZONE 'Europe/Oslo',
