...
import sokos.ske.krav.service.ForsteLinjeFRFeltPosisjon.SENDER_FORSTELINJE_FOM_TIL
import sokos.ske.krav.service.ForsteLinjeFRFeltPosisjon.TRANSFERDATO_FORSTELINJE_FOM_TIL
...
private object ForsteLinjeFRFeltPosisjon {
    val TRANSFERDATO_FORSTELINJE_FOM_TIL = 4 to 18
    val SENDER_FORSTELINJE_FOM_TIL = 18 to 27
}
...
fun parseFRtoDataFirsLineClass(line: String) = with(FixedRecordParser(line)) {
    ...
    FirstLine(
        transferDate = TRANSFERDATO_FORSTELINJE_FOM_TIL.parseString(),
        sender = SENDER_FORSTELINJE_FOM_TIL.parseString(),
    )
}
