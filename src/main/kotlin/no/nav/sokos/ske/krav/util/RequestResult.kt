...
const val AVSKREVET_KAN_IKKE_ENDRES = "avskrevet-innkrevingsoppdrag-kan-ikke-endres"
const val AVSKREVET_KAN_IKKE_AVSKRIVES = "avskrevet-innkrevingsoppdrag-kan-ikke-avskrives"
...
private fun handleNotFoundError(errorType: String): Status =
    when {
        ...
        errorType.contains(KRAV_IKKE_RESKONTROFORT_RESEND) -> Status.HTTP404_IKKE_RESKONTROFORT_AVSTEMMING
...
private fun handleConflictError(errorType: String): Status =
    when {
        ...
        errorType.contains(AVSKREVET_KAN_IKKE_ENDRES) -> Status.HTTP409_AVSKREVET_KAN_IKKE_ENDRES
        errorType.contains(AVSKREVET_KAN_IKKE_AVSKRIVES) -> Status.HTTP409_AVSKREVET_KAN_IKKE_AVSKRIVES
