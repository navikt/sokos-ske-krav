    ...
    FunSpec(
        {
            ...
            test("Når responsekode er 400 skal krav ha status Status.UGYLDIG_FORESPORSEL_400") {
                val requestResult = RequestResult(mockHttpResponse(400), mockk<KravTable>(), "", "", defineStatus(mockHttpResponse(400)))
            ...
            test("Når responsekode er 403 skal krav ha status Status.INGEN_TILGANG_403") {
                val requestResult = RequestResult(mockHttpResponse(403), mockk<KravTable>(), "", "", defineStatus(mockHttpResponse(403)))
            ...
            test("Når responsekode er 404 og typen ikke gjenkjennes, skal krav ha status Status.ANNEN_IKKE_FUNNET_404") {
                val requestResult = RequestResult(mockHttpResponse(404), mockk<KravTable>(), "", "", defineStatus(mockHttpResponse(404)))
            ...
            test("Når responsekode er 406 skal krav ha status Status.FEIL_MEDIETYPE_406") {
                val requestResult = RequestResult(mockHttpResponse(406), mockk<KravTable>(), "", "", defineStatus(mockHttpResponse(406)))
            ...
            test("Når responsekode er 409 og typen ikke gjenkjennes skal krav ha status Status.ANNEN_KONFLIKT_409") {
                val requestResult = RequestResult(mockHttpResponse(409), mockk<KravTable>(), "", "", defineStatus(mockHttpResponse(409)))
            ...
            test("Når responsekode er 422 skal krav ha status Status.VALIDERINGSFEIL_422") {
                val requestResult = RequestResult(mockHttpResponse(422), mockk<KravTable>(), "", "", defineStatus(mockHttpResponse(422)))
            ...
            test("Når responsekode er 500 skal krav ha status Status.INTERN_TJENERFEIL_500") {
                val requestResult = RequestResult(mockHttpResponse(500), mockk<KravTable>(), "", "", defineStatus(mockHttpResponse(500)))
            ...
            test("Når responsekode er 503 skal krav ha status Status.UTILGJENGELIG_TJENESTE_503") {
                val requestResult = RequestResult(mockHttpResponse(503), mockk<KravTable>(), "", "", defineStatus(mockHttpResponse(503)))
            ...
            test("Når responsekode er i 300-serien og ikke spesifikt dekket så skal krav ha status Status.REDIRECTION_FEIL_300") {
                val requestResult = RequestResult(mockHttpResponse(301), mockk<KravTable>(), "", "", defineStatus(mockHttpResponse(301)))
            ...
            test("Når responsekode er i 400-serien og ikke spesifikt dekket så skal krav ha status Status.ANNEN_KLIENT_FEIL_400") {
                val requestResult = RequestResult(mockHttpResponse(420), mockk<KravTable>(), "", "", defineStatus(mockHttpResponse(420)))
            ...
            test("Når responsekode er i 500-serien og ikke spesifikt dekket så skal krav ha status Status.ANNEN_SERVER_FEIL_500") {
                val requestResult = RequestResult(mockHttpResponse(502), mockk<KravTable>(), "", "", defineStatus(mockHttpResponse(502)))
            ...
            test("Når responsekode ikke er dekket så skal krav ha status Status.UKJENT_FEIL") {
                val requestResult = RequestResult(mockHttpResponse(102), mockk<KravTable>(), "", "", defineStatus(mockHttpResponse(102)))
