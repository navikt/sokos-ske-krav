    ...
    FunSpec(
        {
            ...
            test("Når response er success (200) skal defineStatusWithError returnere KRAV_SENDT og null FeilResponse") {
                val (status, feilResponse) = defineStatusWithError("", HttpStatusCode.OK)
            ...
            test("Når response er ukjent statuskode skal defineStatusWithError returnere UKJENT_FEIL og FeilResponse") {
                ...
                val (status, feilResponse) = defineStatusWithError(expectedFeilResponse.encodeToString(), HttpStatusCode.fromValue(999))
            ...
            test("Når response er 404 uten FeilResponse (null) skal defineStatusWithError bruke default FEIL_FRA_SERVER type") {
                val (status, feilResponse) = defineStatusWithError("invalid json", HttpStatusCode.NotFound)
            ...
            test("Når responsekode er 400 skal krav ha status Status.UGYLDIG_FORESPORSEL_400") {
                ...
                val (status, feilResponse) = defineStatusWithError(expectedFeilResponse.encodeToString(), HttpStatusCode.BadRequest)
            ...
            test("Når responsekode er 401 skal krav ha status Status.FEIL_AUTENTISERING_401") {
                ...
                val (status, feilResponse) = defineStatusWithError(expectedFeilResponse.encodeToString(), HttpStatusCode.Unauthorized)
            ...
            test("Når responsekode er 403 skal krav ha status Status.INGEN_TILGANG_403") {
                ...
                val (status, feilResponse) = defineStatusWithError(expectedFeilResponse.encodeToString(), HttpStatusCode.Forbidden)
            ...
            test("Når responsekode er 404 og typen inneholder KRAV_EKSISTERER_IKKE, skal krav ha status Status.FANT_IKKE_SAKSREF_404") {
                ...
                val (status, feilResponse) = defineStatusWithError(expectedFeilResponse.encodeToString(), HttpStatusCode.NotFound)
            ...
            test("Når responsekode er 406 skal krav ha status Status.HTTP406_FEIL_MEDIETYPE") {
                ...
                val (status, feilResponse) = defineStatusWithError(expectedFeilResponse.encodeToString(), HttpStatusCode.NotAcceptable)
            ...
            test("Når responsekode er 409 og typen inneholder KRAV_ER_AVSKREVET skal krav ha status Status.KRAV_ER_AVSKREVET_409") {
                ...
                val (status, feilResponse) = defineStatusWithError(expectedFeilResponse.encodeToString(), HttpStatusCode.Conflict)
            ...
            test("Når responsekode er 422 skal krav ha status Status.VALIDERINGSFEIL_422") {
                ...
                val (status, feilResponse) = defineStatusWithError(expectedFeilResponse.encodeToString(), HttpStatusCode.UnprocessableEntity)
            ...
            test("Når responsekode er 500 skal krav ha status Status.INTERN_TJENERFEIL_500") {
                ...
                val (status, feilResponse) = defineStatusWithError(expectedFeilResponse.encodeToString(), HttpStatusCode.InternalServerError)
            ...
            test("Når responsekode er 503 skal krav ha status Status.UTILGJENGELIG_TJENESTE_503") {
                ...
                val (status, feilResponse) = defineStatusWithError(expectedFeilResponse.encodeToString(), HttpStatusCode.ServiceUnavailable)
            ...
            test("Når responsekode er i 300-serien og ikke spesifikt dekket så skal krav ha status Status.REDIRECTION_FEIL_300") {
                ...
                val (status, feilResponse) = defineStatusWithError(expectedFeilResponse.encodeToString(), HttpStatusCode.MovedPermanently)
            ...
            test("Når responsekode er i 400-serien og ikke spesifikt dekket så skal krav ha status Status.ANNEN_KLIENT_FEIL_400") {
                ...
                val (status, feilResponse) = defineStatusWithError(expectedFeilResponse.encodeToString(), HttpStatusCode.fromValue(420))
            ...
            test("Når responsekode er i 500-serien og ikke spesifikt dekket så skal krav ha status Status.ANNEN_SERVER_FEIL_500") {
                ...
                val (status, feilResponse) = defineStatusWithError(expectedFeilResponse.encodeToString(), HttpStatusCode.BadGateway)
