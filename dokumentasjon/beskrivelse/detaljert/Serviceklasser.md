...
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 2xx uten `kravidentifikator` i responsen           Setter status `UKJENT_FEIL`. Lagrer feilmelding i DB. Sender Slack-alarm med tittel `KRAVIDENTIFIKATOR_MANGLER_I_RESPONS` – kun én gang per `saksnummerNAV` (deduplication).           
