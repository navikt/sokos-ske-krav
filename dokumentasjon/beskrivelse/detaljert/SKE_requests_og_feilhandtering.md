...
Bygges av [`createOpprettKravRequest()`](../../../src/main/kotlin/no/nav/sokos/ske/krav/util/CreateRequests.kt) i [`CreateRequests.kt`](../../../src/main/kotlin/no/nav/sokos/ske/krav/util/CreateRequests.kt).

| Felt i request                                   | Kilde i NAV-modellen                                                                                                        | Merknad                                                                                                                      |
|--------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------|
| `kravtype`                                       | [`StonadsType.getStonadstype(kravkode, kodeHjemmel)`](../../../src/main/kotlin/no/nav/sokos/ske/krav/domain/StonadsType.kt) | Mappes fra kravkode + hjemmelkode                                                                                            |
...
Bygges av [`createEndreRenteRequest()`](../../../src/main/kotlin/no/nav/sokos/ske/krav/util/CreateRequests.kt).
...
Bygges av [`createEndreHovedstolRequest()`](../../../src/main/kotlin/no/nav/sokos/ske/krav/util/CreateRequests.kt).
...
Bygges av [`createStoppKravRequest()`](../../../src/main/kotlin/no/nav/sokos/ske/krav/util/CreateRequests.kt).
...
Logikken i [`createKravidentifikatorPair()`](../../../src/main/kotlin/no/nav/sokos/ske/krav/util/Serviceutils.kt):
...
### 2.1 Statuskonformering for endringer ([`EndreKravService`](../../../src/main/kotlin/no/nav/sokos/ske/krav/service/EndreKravService.kt))
...
Alle kall mot SKE returnerer et [`RequestResult`](../../../src/main/kotlin/no/nav/sokos/ske/krav/util/RequestResult.kt). Funksjonen `defineStatus()` mapper HTTP-statuskode og SKE-feiltype til intern `Status`-enum:
...
| `melding`               | `detail`-feltet fra SKEs [`FeilResponse`](../../../src/main/kotlin/no/nav/sokos/ske/krav/dto/ske/responses/FeilResponses.kt), eller rå respons-body ved parse-feil |
| `nav_request`           | JSON-serialisert request-body                                                                                                                                      |
| `ske_response`          | Rå HTTP-respons-body fra SKE                                                                                                                                       |

En [`FeilResponse`](../../../src/main/kotlin/no/nav/sokos/ske/krav/dto/ske/responses/FeilResponses.kt) fra SKE har følgende format:
...
2. Responsen deserialiseres til [`ValideringsFeilResponse`](../../../src/main/kotlin/no/nav/sokos/ske/krav/dto/ske/responses/FeilResponses.kt):
...
- For [`OpprettKravService`](../../../src/main/kotlin/no/nav/sokos/ske/krav/service/OpprettKravService.kt) og [`StoppKravService`](../../../src/main/kotlin/no/nav/sokos/ske/krav/service/StoppKravService.kt): `break` ut av sending-løkken – ingen flere krav sendes i denne kjøringen
- For [`EndreKravService`](../../../src/main/kotlin/no/nav/sokos/ske/krav/service/EndreKravService.kt): `break` ut av gruppe-løkken
...
- Blokkerer neste planlagte kjøring ([`handleNewKrav`](../../../src/main/kotlin/no/nav/sokos/ske/krav/service/SkeService.kt) returnerer tidlig)
